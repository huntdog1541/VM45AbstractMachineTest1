...
public class PrintUtils
{
    ...
    public static String getFormattedString(String binary, int intervals, String interjects)
    {
        ...
        for(int i = 0; i < size; i = i + intervals)
        {
            if((i+intervals) < size)
    ...
    public static String getBinaryPosition(String binary, int size, int startPosition, int endPosition)
    {
        return binary.substring(startPosition, endPosition);
    }
}
